	...
	<div class="row">
		...
		<div class="col-xl-12">
			...
			<div class="panel panel-primary">
                ...
                <a href="{{ route('dosen.nilaiseminar') }}" class="btn btn-warning">Kembali</a>
                    <br/><br/>
                <form method="POST" class="margin-bottom-0" action="{{ route('dosen.updatenilaiseminar', ['id' => $nilai->id_nilai]) }}">
                        {{ csrf_field() }}
