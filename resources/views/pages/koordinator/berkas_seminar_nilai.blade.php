...
@section('title', 'Nilai Seminar Hasil')
	...
	<div class="row">
		...
		<div class="col-xl-12">
			...
			<div class="panel panel-primary">
				...
				<form action="{{ route('koor.nilaiseminar') }}" method="GET" class="form-inline">
					...
					<table id="data-table-responsive" class="table table-striped table-bordered table-td-valign-middle">
						...
						<tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($p->isStatus == 0)
                                        <a href="{{ route('koor.editnilaiseminar', ['id' => $p->id_nilai] ) }}" class="btn btn-primary">Edit</a>
                                    @else
